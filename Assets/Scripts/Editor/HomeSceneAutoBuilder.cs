...
public class HomeSceneAutoBuilder
{
    ...
    public static void BuildHomeSceneUI()
    {
        ...
        // Guide Button (Thử thách trí tuệ)
        GameObject guideBtn = CreateButton(mainPanel.transform, "GuideButton", "Thử thách trí tuệ", new Vector2(600, 100), new Vector2(0, -1050));
        ...
        AddButtonEvent(guideBtn, manager, "GoToGame");
    ...
    private static void AddButtonEvent(GameObject buttonObj, GameObject targetObj, string methodName)
    {
        ...
        call.FindPropertyRelative("m_Target").objectReferenceValue = targetObj.GetComponent(methodName == "GoToARScan" || methodName == "OpenGuide" || methodName == "CloseGuide" || methodName == "GoToGame"
